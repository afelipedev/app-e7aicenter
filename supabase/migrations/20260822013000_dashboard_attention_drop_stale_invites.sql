-- A faixa "Precisa de atenção" não deve listar team_invite legado: o payload
-- não traz nome da equipe e há convites não lidos de maio/julho para quase
-- todos os usuários, o que parece um item fixo igual em qualquer perfil.
-- Notificações na faixa ficam restritas aos últimos 21 dias.
