...
import { Send, Calculator, Loader2, Menu } from "lucide-react";
...
const ASSISTANT_TYPE = "accounting";
          ...
          <div className={cn(
            ...
            <div className={cn(
              ...
              <div className="flex items-center gap-3 flex-1 w-full">
                ...
                <div className={cn(
                  "rounded-lg bg-gradient-pink flex items-center justify-center shrink-0",
